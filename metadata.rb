...
depends 'rvm',     github: 'fnichol/chef-rvm' # must use version from github: 'fnichol/chef-rvm'
depends 'monit',   github: 'phlipper/chef-monit' # must use version from github: 'phlipper/chef-monit'
